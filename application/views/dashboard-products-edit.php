        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <!--e breadcrumb-->
                    <form class="form-horizontal" id="product_form" role="form" action="<?=  site_url('products/edit_process/'.$product['id']);?>" method="POST" enctype="multipart/form-data" >
                            ...
                            <div class="col-md-10">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                        ...
                                        ?>
                                        <img src="{path}upload/products/thumbnail/<?=$product['image'][0].'_thumb.'.$product['image'][1];?>" style="height: 140px; width: 200px;" id="preview" alt="">
                                    </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control validate[required]" data-prompt-position="bottomLeft" value="<?=$product['product_name'];?>" name="product_name" placeholder="Please enter product name">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control validate[required,number]" value="<?=$product['cost_points'];?>" data-prompt-position="bottomLeft" name="cost_points" placeholder="Please enter cost points">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control validate[required, integer]" value="<?=$product['balance'];?>" name="balance" data-prompt-position="bottomLeft" placeholder="Please enter product balance">
                              <?=form_error('balance');?>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <select name="receive_mode" class="form-control validate[required]" data-prompt-position="bottomLeft">
                                  <option <?=($product['receive_mode'] == 'onpick')?'selected':'';?> value="onpick">On-Pick</option>
                                  <option <?=($product['receive_mode'] == 'delivery')?'selected':'';?> value="delivery">Delivery</option>
                              </select>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control validate[required]" data-prompt-position="bottomLeft" value="<?=$product['start_date'];?>" id="start_date" name="start_date" placeholder="Please enter start date">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control validate[required]" data-prompt-position="bottomLeft" value="<?=$product['due_date'];?>" id="due_date" name="due_date" placeholder="Please enter end date">
                              <?=form_error('due_date');?>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <!-- Build your select: -->
                                <select id="vendors_multiselect" name="vendors[]" class="validate[required]" data-prompt-position="bottomLeft" multiple="multiple">
                                    <?php
                                        if ($vendors != null)
                                            foreach ($vendors as $vendor)
                                                echo '<option '.(in_array($vendor['id'], $vendor_id)?'selected':'').' value='.$vendor['id'].'>'.$vendor['name'].'</option>';
                                    ?>
                                </select>
                        ...
                        <input type="submit" value="Update" class="btn btn-success btn-lg" style="float: right;" />
